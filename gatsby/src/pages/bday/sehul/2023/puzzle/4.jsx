      ...
      <div className="">
        ...
        <div className="container my-5  text-size-5">
          ...
          <div className="my-3 text-size-5">
            <div className="">
              <code>INSTRUCTION</code>: Learn and Play a game of Topple with
              Vyom and Aavya .. Now gift Topple to Vyom and Gift Dr Suess To
              Aavya! Did sharing make you happy?
            </div>
          </div>
