...
export const base_link = "/bday/sehul/2023";
export const base_class = "bday_sehul_2023";
...
export function BDayForm(props) {
  ...
  return (
    <div className="">
      <div className="">
        <h1 className="mb-5 text-white"> {props.title}</h1>
        <div className="">
      ...
      <div className="container my-5">
        <div className="my-3 mx-5 px-5 ">
          <code className="inst">INSTRUCTION</code>
          <div className="mx-5 px-5 ">{props.instruction}</div>
        </div>

        <div className="my-5 ">
          <div className="">
            <code className="hint">HINT</code> goes here 👇
          </div>
          <input
            type="text"
            className=""
